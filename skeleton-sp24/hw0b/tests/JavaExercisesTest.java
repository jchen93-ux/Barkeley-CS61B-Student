...
public class JavaExercisesTest {
    ...
    public void testMakeDice() {
        int[] dice = JavaExercise.makeDice();
    ...
    public void testTakeOrder() {
        String[] order1 = JavaExercise.takeOrder("Ergun");
        String[] order2 = JavaExercise.takeOrder("Erik");
        ...
        String[] order3 = JavaExercise.takeOrder("Noah");
    ...
    public void testFindMinMax() {
        ...
        assertThat(JavaExercise.findMinMax(test1)).isEqualTo(5);

        int[] test2 = new int[]{2, 4, 6, 8};
        assertThat(JavaExercise.findMinMax(test2)).isEqualTo(6);
    }
    ...
    public void testHailstone() {
        List<Integer> result = JavaExercise.hailstone(20);
